...
class Agent implements \JsonSerializable {
	...
	public function __construct( $receiver = array() ) {
		...
		if ( isset( $receiver['agent_no'] ) ) {
			$this->set_agent_no( $receiver['agent_no'] );
		}
		...
		if ( isset( $receiver['name_line1'] ) ) {
			$this->set_name_line1( $receiver['name_line1'] );
		}

		if ( isset( $receiver['name_line2'] ) ) {
			$this->set_name_line2( $receiver['name_line2'] );
		}
		...
		if ( isset( $receiver['postalCode'] ) ) {
			$this->set_postal_code( $receiver['postalCode'] );
		}
	 ...
	 * @return string|null
	 */
	public function get_agent_no(): ?string {
	 ...
	 * @return self
	 */
	public function set_agent_no( ?string $agent_no ): self {
