 ...
 * Request_Exception it throws on any other status - so both success and
...
final class Response {
	 ...
	 * Exceptions\Validation_Exception::errors() for the normalized view.
	 *
	 * @return  array
	 */
	 ...
	 * @return  float|null
	 */
	public function started_at(): ?float {
	 ...
	 * @return  float|null
	 */
	public function completed_at(): ?float {
