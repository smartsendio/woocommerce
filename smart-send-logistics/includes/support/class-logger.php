...
class Logger {
	...
	/**
	 * Log an API request/response cycle as reported by the Smart Send client.
	 *
	 ...
	 *
	 * @param array $context {
	 *     Request/response data from \Smart_Send\API\Client.
	 *
	...
	public static function is_enabled() {
		...
		return ( new Settings() )->debug_log( true );
	}
