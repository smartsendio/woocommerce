...
use Smart_Send\Shipping_Method\Method_Settings;
 ...
 * Method_Settings' form field definitions, so each option
...
class Settings {
	 ...
	 * site:token pairs - see API_Credentials).
	 *
	 * @var string
	 */
