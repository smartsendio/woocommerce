 ...
 * SS_SHIPPING_WC() accessor. This class loads every class file, constructs
...
if ( ! class_exists( 'SS_Shipping_WC' ) ) :
    ...
    class SS_Shipping_WC
    {
		...
		public function includes() {
			...
			require_once SS_SHIPPING_PLUGIN_DIR_PATH . '/includes/delivery/class-ss-shipping-not-connected-exception.php';
