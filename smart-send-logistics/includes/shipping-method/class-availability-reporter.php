 ...
 * Method to the two logging surfaces (#92): the log gets
...
class Availability_Reporter {
	...
	public function report_free_shipping_availability( $method_title, $requires, $is_available, $total, $min_amount ) {
		...
		Logger::debug( $log_message, array( 'requires' => $requires ) );
	}
	...
	protected function shipping_class_messages() {
		return array(
			Method_Settings::SHIPPING_CLASS_OPT_ALL  => array(
				'available'   => array(
			...
			Method_Settings::SHIPPING_CLASS_OPT_ONE  => array(
				'available'   => array(
			...
			Method_Settings::SHIPPING_CLASS_OPT_NALL => array(
				'available'   => array(
			...
			Method_Settings::SHIPPING_CLASS_OPT_NONE => array(
				'available'   => array(
	...
	protected function free_shipping_messages() {
		return array(
			Method_Settings::REQUIRES_MIN_AMOUNT => array(
				'available'   => array(
					'with_amounts' => true,
			...
			Method_Settings::REQUIRES_COUPON     => array(
				'available'   => array(
			...
			Method_Settings::REQUIRES_BOTH       => array(
				'available'   => array(
					'with_amounts' => true,
			...
			Method_Settings::REQUIRES_EITHER     => array(
				'available'   => array(
					'with_amounts' => true,
