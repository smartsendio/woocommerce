...
if ( ! class_exists( 'SS_Shipping_Delivery_Details' ) ) :
	 ...
	 *     'pickup_point'    => SS_Shipping_Pickup_Point::to_array()  // a full point, or just array( 'agent_no' => '1234' )
	 *                          | array( 'clear' => true )            // clear the stored pickup point
	 *                          | null,                               // keep the stored/derived one
	 *     'parcel_plan'     => SS_Shipping_Parcel_Plan::to_array() | null,
	 *     'addons'          => array,
	 *   )
	 *
	...
	class SS_Shipping_Delivery_Details {
		...
		public static function from_array( array $data ): self {
			...
			if ( isset( $data['parcel_plan'] ) && is_array( $data['parcel_plan'] ) ) {
				$details->set_parcel_plan( SS_Shipping_Parcel_Plan::from_array( $data['parcel_plan'] ) );
			}
