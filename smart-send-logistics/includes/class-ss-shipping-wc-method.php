	...
	class SS_Shipping_WC_Method extends WC_Shipping_Flat_Rate {
		...
		public function load_admin_scripts( $hook ) {
			...
			wp_enqueue_script(
				...
				SS_SHIPPING_PLUGIN_DIR_URL . '/assets/js/ss-shipping-admin.js',
				array( 'jquery' ),
				SS_SHIPPING_VERSION
			);
			...
			wp_enqueue_script(
				...
				SS_SHIPPING_PLUGIN_DIR_URL . '/assets/js/ss-shipping-test-connection.js',
				array( 'jquery' ),
				SS_SHIPPING_VERSION
			);
