...
if ( ! class_exists( 'SS_Shipping_Fulfillment_Result' ) ) :
	 ...
	 * SS_Shipping_Booking_Exception, plus the merchant-facing HTML
	...
	class SS_Shipping_Fulfillment_Result {
		 ...
		 * @return integer|null
		 */
		public function get_order_note_id( SS_Shipping_Booked_Shipment $shipment ): ?int {
			$entry = $this->find_entry( $shipment );
		 ...
		 * @return string[]|null
		 */
		public function get_warnings( SS_Shipping_Booked_Shipment $shipment ): ?array {
			$entry = $this->find_entry( $shipment );
		 ...
		 *          'shipment' => SS_Shipping_Booked_Shipment::to_array(),
