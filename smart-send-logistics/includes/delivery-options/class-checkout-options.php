 ...
 * on Method_Code, which expresses the booking service, not
...
class Checkout_Options {
	 ...
	 *
	 * @param Method_Code $method_code The selected shipping method's code.
	 *
	 * @return bool
	 */
	public function show_pickup_points( Method_Code $method_code ): bool {
	...
	public function pickup_point_status_for_exception( \Exception $e ): string {
		if ( $e instanceof Not_Connected_Exception ) {
		...
		if ( $e instanceof \Smart_Send\API\Exceptions\Forbidden_Exception ) {
