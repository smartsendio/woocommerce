 ...
 *
 * @package  SS_Shipping_Pickup_Point_Not_Found_Exception
 * @category Shipping
 * @author   Smart Send
 */
...
if ( ! class_exists( 'SS_Shipping_Pickup_Point_Not_Found_Exception' ) ) :

	/**
	 * An agent number could not be resolved into a pickup point (#182).
	 *
	 * Thrown by SS_Shipping_Pickup_Point_Lookup::find_by_agent_no() when
	 ...
	 */
	class SS_Shipping_Pickup_Point_Not_Found_Exception extends \Exception {
