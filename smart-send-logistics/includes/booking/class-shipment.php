 ...
 * Shipment_Builder from Order_Reader's output
 ...
 * agent_no/agent.
 *
 * Parcels are typed Parcel value objects (#139) - the one
 ...
 * \Smart_Send\API\Resources\Booking_Resource::from_shipment(), which already
 ...
 * \Smart_Send\API\Resources\Booking_Resource::from_shipment()'s job. It also
 ...
 * API client (includes/api/) purely by
 * its fully-qualified global name (\Shipment).
 */
class Shipment {
	...
	/**
	 * Receiver data, see Order_Reader::get_receiver_data().
	 *
	 * @var array|null
	 */
	...
	/**
	 * The resolved parcels (#139): typed Parcel value
	 ...
	 *
	 * @param Parcel[] $parcels The resolved parcels.
	 *
	 * @return self
	 */
