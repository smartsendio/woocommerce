 ...
 * (Shipment) from them is the job of
 * Shipment_Builder.
 */
class Order_Reader {
	 ...
	 */
	public function __construct( WC_Order $order, ?Settings $settings = null ) {
		$this->order    = $order;
	 ...
	 * method - see the class docblock on Shipment_Builder
	 ...
	 * - see the class docblock on Shipment_Builder for the
