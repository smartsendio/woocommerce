...
class Checkout {
	...
	public function display_ss_pickup_points( $method, $index ) {
		...
		if ( Checkout_Options::PICKUP_POINT_STATUS_FOUND === $status ) {
			 ...
			 * @param Pickup_Point[] $ss_pickup_points        The pickup points shown in the drop-down (typed value objects, not raw API objects - #170).
			 *
