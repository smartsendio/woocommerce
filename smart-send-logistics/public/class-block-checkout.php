 ...
 * Method) - this plugin loads before WooCommerce. The
 * interface itself is guaranteed by the plugin's WC 8.2 floor.
 *
 * @package Smart_Send
 * @category Shipping
 * @author   Smart Send
...
class Block_Checkout implements IntegrationInterface {
	 ...
	 * cart extension data (Store_API::cart_extension_data())
