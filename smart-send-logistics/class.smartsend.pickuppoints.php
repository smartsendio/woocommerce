...
if ( ! class_exists( 'Smartsend_Logistics_PickupPoints' ) ) {
	class Smartsend_Logistics_PickupPoints extends WC_Shipping_Method {
		...
		public function init() {
			...
			$this->active_pickup_GLS   		= $this->get_option( 'active_pickup_GLS' );
