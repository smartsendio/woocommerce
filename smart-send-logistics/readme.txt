...
* Breaking change: bulk printing of shipping labels is removed - the "Smart Send - Generate Labels" / "Generate Return Labels" bulk actions are no longer offered on the Orders screen. We are building a much better version, and it is coming soon. Labels can still be created one order at a time from the order page; if you need the old bulk printing, downgrade to version 8.1.3 - see the "9.0.0" entry under Upgrade Notice
...
* Bulk printing of shipping labels from the Orders screen is removed: the "Smart Send - Generate Labels" and "Smart Send - Generate Return Labels" bulk actions are no longer offered. We are building a much better version of bulk printing, and it is coming soon. Until then, labels can be created one order at a time with the "Generate label" button on the order page. If you need the old bulk printing, stay on or downgrade to version 8.1.3, available under "Previous versions" on the [Advanced View](https://wordpress.org/plugins/smart-send-logistics/advanced/) page.
