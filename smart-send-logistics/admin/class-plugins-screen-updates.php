...
class Plugins_Screen_Updates {
	...
	public function in_plugin_update_message( $args, $response ) {
		...
		echo apply_filters( 'ss_in_plugin_update_message', '</p>' . wp_kses_post( $this->get_upgrade_notice() ) . '<p class="dummy">' ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped, WordPress.NamingConventions.PrefixAllGlobals.NonPrefixedHooknameFound -- Sanitised notice HTML; retained public hook name.
	}
